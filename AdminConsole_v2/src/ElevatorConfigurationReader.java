...
public class ElevatorConfigurationReader {
	...
	public static void showElevator() {
		...
		UserPanelConfiguration
				.setSelection(GuiConfiguration.getUserPanelType());

		// Setting floorpanel configuration
		FloorPanelConfiguration
				.setButtonColor(resolveFloorPanelColor(GuiConfiguration
						.getFloorPanelColor()));
		FloorPanelConfiguration
				.setActiveButtonColor(resolveFloorPanelColor(GuiConfiguration
						.getFloorPanelPressedButtonColor()));
		FloorPanelConfiguration.setTextType(GuiConfiguration
				.getFloorPanelDisplay());
		FloorPanelConfiguration.setNumAlarmIndicators(GuiConfiguration
				.getNumOfCars());

		// Setting userpanel configuration
		UserPanelConfiguration
				.setButtonColor(resolveUserPanelColor(GuiConfiguration
						.getUserPanelColor()));
		UserPanelConfiguration
		...
		MetaControllerConfiguration.setAlgorithm(GuiConfiguration
				.getAlgorithmType());
		...
		if (doorConfiguration.trim().equalsIgnoreCase(
				"Alternate Single/Double Door")) {
