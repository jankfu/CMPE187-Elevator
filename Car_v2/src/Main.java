...
public class Main {
	...
	JComboBox list2 = new JComboBox(new String[] { "testdoor", "singledoor",
			"doubledoor" });
	JComboBox list3 = new JComboBox(new String[] { "testuserpanelqueue",
			"default" });
	...
	class ButtonListener implements ActionListener {
		...
		public void actionPerformed(ActionEvent arg0) {
			...
			CarConfiguration.setUserPanelQueueType((String) list3
					.getSelectedItem());
			JFrame frame = new JFrame();
